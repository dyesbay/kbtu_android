    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                intent.putExtra("team_title", team.getTitle());
                intent.putExtra("team_nickname", team.getNickname());
                intent.putExtra("team_founded", team.getFounded());
                intent.putExtra("team_stadium", team.getStadium());
                intent.putExtra("team_history", team.getHistory());
                intent.putExtra("team_logo", team.getLogo());
        ...
        setTitle("Футбольные клубы Англии");
        generateData();
    }
